...
# --- ГРАНУЛЯРНЫЙ КАТЕГОРИЗАТОР С ВШИТОЙ БАЗОЙ ---
def detect_category_granular(name_input):
    name = str(name_input).strip().lower()
    
    # 1. ЖЕСТКАЯ БАЗА (ИЗ ТВОЕГО ФАЙЛА)
    manual_dict = {
        ...
        'milk punch виски-вишня': '🥃 Виски',
        'milk punch ром-кокос': '🍹 Коктейли',
        'nevermind': '🍹 Коктейли',
        'party-mix с виски': '🥃 Виски',
        'passion star martini': '🍹 Коктейли',
        'pineapple spritz dmf pineapple': '🍹 Коктейли',
        'rum bubble': '🍹 Коктейли',
        'zombieville': '🍹 Коктейли',
        'авторское рислинг 125мл': '🍷 Вино',
        'авторское совиньон блан 125мл': '🍷 Вино',
        'авторское совиньон блан 750мл': '🍷 Вино',
        'айриш кофе': '🍹 Коктейли',
        'антико итальяно 125мл': '🍷 Вино',
        'антико итальяно 700мл': '🍷 Вино',
        'апельсин 20г': '🍬 Доп. ингредиенты',
        'апероль шприц': '🍹 Коктейли',
        'асканели 40мл': '🍇 Коньяк/Бренди',
        'балантайнс 40мл': '🥃 Виски',
        'бандидо 40мл': '🌵 Текила',
        'белая березка 40мл': '💧 Водка',
        'белуга нобл 40мл': '💧 Водка',
        'белый русский': '🍹 Коктейли',
        'берн 0,33': '🥤 Стекло/Банка Б/А',
        'биттербулл': '🍹 Коктейли',
        'блэк рэм 40 мл': '🥃 Виски',
        'блэк шип 500мл': '🍺 Пиво Розлив',
        'боржоми 0,5': '🥤 Стекло/Банка Б/А',
        'брамбл': '🍹 Коктейли',
        'брум в асс. 40мл': '🌲 Джин',
        'вино местное 125мл': '🍷 Вино',
        'вино местное ежевичное 125мл': '🍺 Пиво Розлив',
        'виски кола': '🍹 Коктейли',
        'вода с лимоном': '🚰 Розлив Б/А',
        'гато негро 125мл': '🍷 Вино',
        'гленливет 12 лет 40мл': '🥃 Виски',
        'глинтвей б/а': '🧉 Коктейль Б/А',
        'глинтвейн': '🍹 Коктейли',
        'глинтвейн б/а бур': '🧉 Коктейль Б/А',
        'глинтвейн белый': '🍹 Коктейли',
        'глинтвейн белый б/а': '🧉 Коктейль Б/А',
        'глинтвейн бур': '🍹 Коктейли',
        'голубые гаваи': '🍹 Коктейли',
        'грейпфрутовый фреш 250 мл': '🍓 Милк/Фреш/Смузи',
        'дайкири в ассортименте': '🍹 Коктейли',
        'джемесон 40мл': '🥃 Виски',
        'джин-тоник': '🥤 Стекло/Банка Б/А',
        'джин-тропик': '🍹 Коктейли',
        'егермейстер 40мл': '🍒 Ликер/Настойка',
        'иван чай 400мл бур': '🍵 Чай',
        'капучино с кокосовым молоком': '☕ Кофе',
        'капучино с миндальным молоком': '☕ Кофе',
        'космополитен': '🍹 Коктейли',
        'кофе американо 150 мл': '☕ Кофе',
        'кофе американо бур': '☕ Кофе',
        'кофе американо для персонала': '☕ Кофе',
        'кофе двойной американо бур': '☕ Кофе',
        'кофе двойной капучино бур': '☕ Кофе',
        'кофе капучино': '☕ Кофе',
        'кофе капучино для персонала': '☕ Кофе',
        'кофе латте': '☕ Кофе',
        'кофе латте бур': '☕ Кофе',
        'кофе по восточном': '☕ Кофе',
        'кофе со специями': '☕ Кофе',
        'кофе эспрессо': '☕ Кофе',
        'кофе эспрессо двойной': '☕ Кофе',
        'красностоп, корвина 125мл': '🍷 Вино',
        'крушовице 0,33': '🍾 Пиво ШТ',
        'крушовице 0,33 б/а': '🥤 Стекло/Банка Б/А',
        'крушовице темное 500мл': '🍺 Пиво Розлив',
        'крушовице черне, 0,45': '🍾 Пиво ШТ',
        'куба либре': '🍹 Коктейли',
        'лайм 20г': '🍬 Доп. ингредиенты',
        'ламбруско\xa0 125мл': '🍷 Вино',
        'латте с кокосовым молоком': '☕ Кофе',
        'латте с миндальным молоком': '☕ Кофе',
        'ле гран 125мл': '🍷 Вино',
        'ле гран нуар 750мл': '🍷 Вино',
        'лимон 20г': '🍬 Доп. ингредиенты',
        'лонг айленд айс ти': '🍹 Коктейли',
        'май тай': '🍹 Коктейли',
        'маракуйя гуава': '🍵 Чай',
        'маргарита': '🍹 Коктейли',
        'мейзон 500мл': '🍺 Пиво Розлив',
        'местное светлое 1000мл': '🍺 Пиво Розлив',
        'местное светлое 500мл': '🍺 Пиво Розлив',
        'милк шейк ванильный': '🍓 Милк/Фреш/Смузи',
        'милк шейк клубнично-банановый': '🍓 Милк/Фреш/Смузи',
        'милк шейк лесные ягоды': '🍓 Милк/Фреш/Смузи',
        'милк шейк шоколадный': '🍓 Милк/Фреш/Смузи',
        'минеральная вода 0,33': '🥤 Стекло/Банка Б/А',
        'минеральная вода 0,5': '🥤 Стекло/Банка Б/А',
        'молоко 50мл': '🍬 Доп. ингредиенты',
        'морс 250 мл': '🚰 Розлив Б/А',
        'морской бриз малибу': '🍹 Коктейли',
        'мохито б/а': '🧉 Коктейль Б/А',
        'мохито в асс.': '🍹 Коктейли',
        'мята 20г': '🍬 Доп. ингредиенты',
        'мёд 50г': '🍬 Доп. ингредиенты',
        'напиток газированный 0,33': '🥤 Стекло/Банка Б/А',
        'напиток газированный 0,5': '🥤 Стекло/Банка Б/А',
        'напиток газированный розлив 250 мл': '🚰 Розлив Б/А',
        'напиток из сиропа биб (кфс)': '🚰 Розлив Б/А',
        'негрони': '🍹 Коктейли',
        'нк клубника базилик 40 мл': '🍒 Ликер/Настойка',
        'нк кокос 40 мл': '🍒 Ликер/Настойка',
        'нк сливочная лимончелло 40 мл': '🍒 Ликер/Настойка',
        'нк черешня 40 мл': '🍒 Ликер/Настойка',
        'нк щавеливая 40 мл': '🍒 Ликер/Настойка',
        'нк\xa0 фейхоа мята 40 мл': '🍒 Ликер/Настойка',
        'облепиховый чай с имбирём': '🍵 Чай',
        'обнимашки': '🍹 Коктейли',
        'окровавленная мерри': '🍹 Коктейли',
        'онегин 40 мл': '💧 Водка',
        'пино колада б/а': '🧉 Коктейль Б/А',
        'пинья колада': '🍹 Коктейли',
        'пляж лонг айленда': '🍹 Коктейли',
        'просекко шардоне 125мл': '🍷 Вино',
        'пфефферер 125мл': '🍷 Вино',
        'рача': '🍹 Коктейли',
        'ред бул - виски': '🍹 Коктейли',
        'ред булл - водка': '🥤 Стекло/Банка Б/А',
        'ред булл 0,25': '🥤 Стекло/Банка Б/А',
        'ром кола': '🍹 Коктейли',
        'светлое 500мл бур': '🍺 Пиво Розлив',
        'сидр вп пуаре, 0,33л': '🍏 Сидр ШТ',
        'сидр честерс вишня, 0,5': '🍏 Сидр ШТ',
        'сидр честерс лесн. ягоды, 0,5': '🍏 Сидр ШТ',
        'сидр честерс персик-абрикос, 0,45': '🍏 Сидр ШТ',
        'сидр честерс яблоко, 0,5': '🍏 Сидр ШТ',
        'сироп 50мл': '🍬 Доп. ингредиенты',
        'сливки 50мл': '🍬 Доп. ингредиенты',
        'смузи ежевичный': '🍓 Милк/Фреш/Смузи',
        'смузи клубнично-банановый': '🍓 Милк/Фреш/Смузи',
        'сок rich стекло 0,2л, шт': '🥤 Стекло/Банка Б/А',
        'сок в асс. 250мл': '🚰 Розлив Б/А',
        'сэт до еды': '🍹 Коктейли',
        'сэт убийцы': '🍹 Коктейли',
        'текила санрайз': '🌵 Текила',
        'тини 750мл': '🍷 Вино',
        'том коллинз': '🍹 Коктейли',
        'тоник 0,33': '🥤 Стекло/Банка Б/А',
        'торрес 10 лет 40мл': '🍇 Коньяк/Бренди',
        'флэт уайт': '☕ Кофе',
        'фрескеллов асс 125мл': '🍷 Вино',
        'фреш апельсиновый 100 мл для комбо с яблочным': '🍓 Милк/Фреш/Смузи',
        'фреш апельсиновый 200 мл': '🍓 Милк/Фреш/Смузи',
        'фруктовый физ': '🍹 Коктейли',
        'ханс баер рислинг 125мл': '🍷 Вино',
        'ханс баер рислинг 750мл': '🍷 Вино',
        'хаски 40мл': '💧 Водка',
        'хаски берри микс 40мл': '💧 Водка',
        'хххчай ежевика миндаль': '🍵 Чай',
        'чай 800 мл': '🍵 Чай',
        'чай акция, порц': '🍵 Чай',
        'чай бардак бергамота': '🍵 Чай',
        'чай брусничный': '🍵 Чай',
        'чай да хун пао 400 мл': '🍵 Чай',
        'чай ежевика миндаль_': '🍵 Чай',
        'чай иван чай с малиной и травами': '🍵 Чай',
        'чай имбирный 200': '🍵 Чай',
        'чай имбирный 400': '🍵 Чай',
        'чай мандариновый 200': '🍵 Чай',
        'чай мандариновый 400': '🍵 Чай',
        'чай медовое яблоко': '🍵 Чай',
        'чай облепиховый 200': '🍵 Чай',
        'чай облепиховый 400': '🍵 Чай',
        'чай пакетированый бур, порция': '🍵 Чай',
        'чай розмарин 200': '🍵 Чай',
        'чай розмарин 400': '🍵 Чай',
        'чай тегуань инь 400 мл': '🍵 Чай',
        'чивас ригал 12 лет 40мл': '🥃 Виски',
        'чистые росы 40 мл': '💧 Водка',
        'шато тамань селект блан 125мл': '🍷 Вино',
        'эсполон бланко 40мл': '🌵 Текила',
