...
def detect_category_fallback(name_input):
    ...
    manual_dict = {
        ...
        'флэт уайт': '☕ Безалкогольное',
        'сэт убийцы': '🍹 Коктейли',
        'смузи клубнично-банановый': '☕ Безалкогольное',
        'сироп 50мл': '🍬 Доп. ингредиенты',
        'рача': '🍹 Коктейли',
        'пино колада б/а': '☕ Безалкогольное',
        'нк щавеливая 40 мл': '🥃 Крепкое',
        'нк черешня 40 мл': '🥃 Крепкое',
        'нк кокос 40 мл': '🥃 Крепкое',
        'тоник 0,33': '☕ Безалкогольное',
        'светлое 500мл бур': '🍺 Пиво/Сидр',
        'напиток из сиропа биб (кфс)': '☕ Безалкогольное',
        'напиток газированный 0,5': '☕ Безалкогольное',
        'напиток газированный 0,33': '☕ Безалкогольное',
        'глинтвейн бур': '🍹 Коктейли',
        'глинтвейн б/а бур': '☕ Безалкогольное',
        'ящерица лонг айленда': '🍹 Коктейли',
        'нк клубника базилик 40 мл': '🥃 Крепкое',
        'нк  фейхоа мята 40 мл': '🥃 Крепкое',
        'нк фейхоа мята 40 мл': '🥃 Крепкое',
        'дайкири в ассортименте': '🍹 Коктейли',
        'голубые гаваи': '🍹 Коктейли',
        'глинтвейн белый': '🍹 Коктейли',
        'глинтвейн': '🍹 Коктейли',
        'глинтвей б/а': '☕ Безалкогольное',
        'брамбл': '🍹 Коктейли',
        'белый русский': '🍹 Коктейли',
        'бандидо 40мл': '🥃 Крепкое',
        'балантайнс 40мл': '🥃 Крепкое',
        'апельсин 20г': '🍬 Доп. ингредиенты',
        'негрони': '🍹 Коктейли',
        'zombieville': '🍹 Коктейли',
        'егермейстер 40мл': '🥃 Крепкое',
        'капучино с миндальным молоком': '☕ Безалкогольное',
        'космополитен': '🍹 Коктейли',
        'мята 20г': '🍬 Доп. ингредиенты',
        'мохито в асс.': '🍹 Коктейли',
        'молоко 50мл': '🍬 Доп. ингредиенты',
        'милк шейк лесные ягоды': '☕ Безалкогольное',
        'милк шейк клубнично-банановый': '☕ Безалкогольное',
        'милк шейк ванильный': '☕ Безалкогольное',
        'местное светлое 500мл': '🍺 Пиво/Сидр',
        'местное светлое 1000мл': '🍺 Пиво/Сидр',
        'мохито б/а': '☕ Безалкогольное',
        'май тай': '🍹 Коктейли',
        'лайм 20г': '🍬 Доп. ингредиенты',
        'латте с кокосовым молоком': '☕ Безалкогольное',
        'лимон 20г': '🍬 Доп. ингредиенты',
        'лонг айленд айс ти': '🍹 Коктейли',
        'фреш апельсиновый 200 мл': '☕ Безалкогольное',
        'фреш апельсиновый 100 мл для комбо с яблочным': '☕ Безалкогольное',
        'сэт до еды': '🍹 Коктейли',
        'смузи ежевичный': '☕ Безалкогольное',
        'пляж лонг айленда': '🍹 Коктейли',
        'пинья колада': '🍹 Коктейли',
        'капучино с кокосовым молоком': '☕ Безалкогольное',
        'глинтвейн белый б/а': '☕ Безалкогольное',
        'milk punch бурбон-черная смородина': '🍹 Коктейли',
        'clover club': '🍹 Коктейли',
        'black hole': '🍹 Коктейли',
        'banana tiki': '🍹 Коктейли',
        'биттербулл': '🍹 Коктейли',
        'милк шейк шоколадный': '☕ Безалкогольное',
        'куба либре': '🍹 Коктейли',
        'ле гран 125мл': '🍷 Вино',
        'маракуйя гуава': '☕ Безалкогольное',
        'обнимашки': '🍹 Коктейли',
        'напиток газированный розлив 250 мл': '🍹 Коктейли',
        'чистые росы 40 мл': '🥃 Крепкое',
        'грейпфрутовый фреш 250 мл': '☕ Безалкогольное',
        'белая березка 40мл': '🥃 Крепкое',
        'drunk bee': '🍹 Коктейли',
        'rum bubble': '🍹 Коктейли',
        'мёд 50г': '🍬 Доп. ингредиенты',
        'маргарита': '🍹 Коктейли',
        'латте с миндальным молоком': '☕ Безалкогольное',
        'сливки 50мл': '🍬 Доп. ингредиенты',
        'том коллинз': '🍹 Коктейли',
        'окровавленная мерри': '🍹 Коктейли',
    ...
    if any(w in name for w in beer_brands): return '🍺 Пиво/Сидр'
    if any(w in name for w in wine_brands): return '🍷 Вино'
    if any(w in name for w in strong_brands): return '🥃 Крепкое'
    if any(w in name for w in cocktail_brands): return '🍹 Коктейли'
    if any(w in name for w in non_alc_brands): return '☕ Безалкогольное'
