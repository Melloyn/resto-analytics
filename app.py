...
def detect_category_granular(name_input):
    ...
    manual_dict = {
        ...
        'милк шейк шоколадный': '🍓 Милк/Фреш/Смузи', 'минеральная вода 0,33': '🥤 Стекло/Банка Б/А', 
        'минеральная вода 0,5': '🥤 Стекло/Банка Б/А', 'молоко 50мл': '🍬 Доп. ингредиенты', 'морс 250 мл': '🚰 Розлив Б/А', 
        'морской бриз малибу': '🍹 Коктейли', 'мохито б/а': '🧉 Коктейль Б/А', 'мохито в асс.': '🍹 Коктейли', 
        'мята 20г': '🍬 Доп. ингредиенты', 'мёд 50г': '🍬 Доп. ингредиенты', 'напиток газированный 0,33': '🥤 Стекло/Банка Б/А', 
        'напиток газированный 0,5': '🥤 Стекло/Банка Б/А', 'напиток газированный розлив 250 мл': '🚰 Розлив Б/А', 
        'напиток из сиропа биб (кфс)': '🚰 Розлив Б/А', 'негрони': '🍹 Коктейли', 'нк клубника базилик 40 мл': '🍒 Ликер/Настойка', 
        'нк кокос 40 мл': '🍒 Ликер/Настойка', 'нк сливочная лимончелло 40 мл': '🍒 Ликер/Настойка', 
        'нк черешня 40 мл': '🍒 Ликер/Настойка', 'нк щавеливая 40 мл': '🍒 Ликер/Настойка', 
        'нк\xa0 фейхоа мята 40 мл': '🍒 Ликер/Настойка', 'облепиховый чай с имбирём': '🍵 Чай', 'обнимашки': '🍹 Коктейли', 
        'окровавленная мерри': '🍹 Коктейли', 'онегин 40 мл': '💧 Водка', 'пино колада б/а': '🧉 Коктейль Б/А', 
        'пинья колада': '🍹 Коктейли', 'пляж лонг айленда': '🍹 Коктейли', 'просекко шардоне 125мл': '🍷 Вино', 
        'пфефферер 125мл': '🍷 Вино', 'рача': '🍹 Коктейли', 'ред бул - виски': '🍹 Коктейли', 'ред булл - водка': '🥤 Стекло/Банка Б/А', 
        'ред булл 0,25': '🥤 Стекло/Банка Б/А', 'ром кола': '🍹 Коктейли', 'светлое 500мл бур': '🍺 Пиво Розлив', 
        'сидр вп пуаре, 0,33л': '🍏 Сидр ШТ', 'сидр честерс вишня, 0,5': '🍏 Сидр ШТ', 'сидр честерс лесн. ягоды, 0,5': '🍏 Сидр ШТ', 
        'сидр честерс персик-абрикос, 0,45': '🍏 Сидр ШТ', 'сидр честерс яблоко, 0,5': '🍏 Сидр ШТ', 
        'сироп 50мл': '🍬 Доп. ингредиенты', 'сливки 50мл': '🍬 Доп. ингредиенты', 'смузи ежевичный': '🍓 Милк/Фреш/Смузи', 
        'смузи клубнично-банановый': '🍓 Милк/Фреш/Смузи', 'сок rich стекло 0,2л, шт': '🥤 Стекло/Банка Б/А', 
        'сок в асс. 250мл': '🚰 Розлив Б/А', 'сэт до еды': '🍹 Коктейли', 'сэт убийцы': '🍹 Коктейли', 'текила санрайз': '🌵 Текила', 
        'тини 750мл': '🍷 Вино', 'том коллинз': '🍹 Коктейли', 'тоник 0,33': '🥤 Стекло/Банка Б/А', 'торрес 10 лет 40мл': '🍇 Коньяк/Бренди', 
        'флэт уайт': '☕ Кофе', 'фрескеллов асс 125мл': '🍷 Вино', 'фреш апельсиновый 100 мл для комбо с яблочным': '🍓 Милк/Фреш/Смузи', 
        'фреш апельсиновый 200 мл': '🍓 Милк/Фреш/Смузи', 'фруктовый физ': '🍹 Коктейли', 'ханс баер рислинг 125мл': '🍷 Вино', 
        'ханс баер рислинг 750мл': '🍷 Вино', 'хаски 40мл': '💧 Водка', 'хаски берри микс 40мл': '💧 Водка', 
        'хххчай ежевика миндаль': '🍵 Чай', 'чай 800 мл': '🍵 Чай', 'чай акция, порц': '🍵 Чай', 'чай бардак бергамота': '🍵 Чай', 
        'чай брусничный': '🍵 Чай', 'чай да хун пао 400 мл': '🍵 Чай', 'чай ежевика миндаль_': '🍵 Чай', 
        'чай иван чай с малиной и травами': '🍵 Чай', 'чай имбирный 200': '🍵 Чай', 'чай имбирный 400': '🍵 Чай', 
        'чай мандариновый 200': '🍵 Чай', 'чай мандариновый 400': '🍵 Чай', 'чай медовое яблоко': '🍵 Чай', 
        'чай облепиховый 200': '🍵 Чай', 'чай облепиховый 400': '🍵 Чай', 'чай пакетированый бур, порция': '🍵 Чай', 
        'чай розмарин 200': '🍵 Чай', 'чай розмарин 400': '🍵 Чай', 'чай тегуань инь 400 мл': '🍵 Чай', 
        'чивас ригал 12 лет 40мл': '🥃 Виски', 'чистые росы 40 мл': '💧 Водка', 'шато тамань селект блан 125мл': '🍷 Вино', 
        'эсполон бланко 40мл': '🌵 Текила', 'ящерица лонг айленда': '🍹 Коктейли'
    }
...
if st.session_state.df_full is not None:
    ...
    # --- 2. МЕНЮ И КОСТЫ (С ПЕРЕКЛЮЧАТЕЛЕМ) ---
    with tab2:
        # МАППИНГ ДЛЯ ОБОБЩЕНИЯ
        general_mapping = {
            '🥃 Виски': '🥃 Крепкое', '💧 Водка': '🥃 Крепкое', '🏴‍☠️ Ром': '🥃 Крепкое', 
            '🌵 Текила': '🥃 Крепкое', '🌲 Джин': '🥃 Крепкое', '🍇 Коньяк/Бренди': '🥃 Крепкое', 
            '🍒 Ликер/Настойка': '🥃 Крепкое',
            '🍺 Пиво Розлив': '🍺 Пиво/Сидр', '🍾 Пиво ШТ': '🍺 Пиво/Сидр', '🍏 Сидр ШТ': '🍺 Пиво/Сидр',
            '🍷 Вино': '🍷 Вино', '🍹 Коктейли': '🍹 Коктейли',
            '☕ Кофе': '☕ Безалкогольное', '🍵 Чай': '☕ Безалкогольное', 
            '🥤 Стекло/Банка Б/А': '☕ Безалкогольное', '🚰 Розлив Б/А': '☕ Безалкогольное', 
            '🧉 Коктейль Б/А': '☕ Безалкогольное', '🍓 Милк/Фреш/Смузи': '☕ Безалкогольное',
            '🍔 Еда (Кухня)': '🍔 Еда (Кухня)', '🍬 Доп. ингредиенты': '📦 Прочее', '📦 Прочее': '📦 Прочее'
        }

        col_switch, col_dummy = st.columns([1, 2])
        view_mode = col_switch.radio("🔘 Вид категорий:", ["🔍 Подробно (Виски, Кофе...)", "📊 Обобщенно (Крепкое, Б/А...)"])
        
        # Создаем копию для отображения, чтобы не ломать основной df
        df_display = df_view.copy()
        
        if "Обобщенно" in view_mode:
            df_display['Категория'] = df_display['Категория'].map(general_mapping).fillna('📦 Прочее')

        c1, c2 = st.columns([1, 1])
        with c1:
            st.subheader("Структура выручки")
            df_cat = df_display.groupby('Категория')['Выручка с НДС'].sum().reset_index()
            fig_pie = px.pie(df_cat, values='Выручка с НДС', names='Категория', hole=0.4)
            st.plotly_chart(fig_pie, use_container_width=True)
        
        with c2:
            st.subheader("📊 Детальный анализ Фуд-коста")
            df_menu = df_display.groupby('Блюдо').agg({'Выручка с НДС': 'sum', 'Себестоимость': 'sum', 'Количество': 'sum'}).reset_index()
        ...
        uncategorized = df_display[df_display['Категория'].str.contains('Прочее', case=False)]['Блюдо'].unique()
